...
try:
    ...
    sys.path.insert(0, '/home2/ajit.srikanth/asac/ASAC/avobjects/flow/correlation')
    # import correlation.correlation as correlation  # you should consider upgrading python
    import correlation
