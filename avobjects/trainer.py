...
# sys.path.insert(0, '/home2/ajit.srikanth/avobjects/flow')
# import flow.pwcnet.Network as Net  
from flow.pwcnet import Network as Net
...
class DemoEvalTrainer():
    ...
    def eval(self, dataloader):
        ...
        coords = [self.opts.speaker_audio]
        ...
        with open(self.opts.coords_csv, 'a') as f:
    ...
    def avobject_trajectories_from_flow(self, att_map, video):
        ...
        for b_id in range(len(video)):
            ...
            flow = calc_flow_on_vid_wrapper(flow_inp[b_id].detach().cpu().numpy(), network, gpu_id=self.opts.gpu_id)
